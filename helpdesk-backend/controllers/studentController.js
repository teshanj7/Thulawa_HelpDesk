    ...
    try {
        let result = await Student.find({
            $or: [
                ...
                {
                    RegistrationNo: { $regex: req.params.key },
                },
                {
                ...
                {
                    StudentType: { $regex: req.params.key },
                },
                {
...
module.exports = { allStudents, updateStudent, deleteStudent, singleStudent, searchstudents }